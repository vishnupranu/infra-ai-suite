...
export const AIToolCard = ({
  id, name, description, category, price_monthly, price_annual,
  rating, features, affiliate_link, icon_url, is_featured,
}: AIToolCardProps) => {
      ...
      <div className="p-6">
        ...
        <div className="flex flex-col gap-3 pt-4 border-t border-border">
          <div className="flex items-center gap-2">
            ...
            {price_monthly && (
              <span className="text-sm text-muted-foreground">${price_monthly}/mo</span>
            )}
            {price_annual && (
              <span className="text-xs text-muted-foreground">or ${price_annual}/year</span>
            )}
          </div>
          <div className="flex gap-2">
            ...
            <Button size="sm" variant="outline" onClick={() => window.open(affiliate_link, "_blank")}>
